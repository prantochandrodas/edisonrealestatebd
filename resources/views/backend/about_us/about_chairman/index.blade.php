    ...
    <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
        <form method="POST" action="{{ route('about-chairmans.update', $data->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control mb-2" id="summernote" name="company_information" cols="30"
                    rows="2">{{ $data->company_information }}</textarea>
            ...
            <div class="form-group">
                ...
                @if ($data->chairman_image)
                    <img src="{{ asset('about/chairman-image/' . $data->chairman_image) }}" height="100"
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control mb-2" id="summernote2" name="chairman_information" cols="30"
                    rows="2">{{ $data->chairman_information }}</textarea>
            ...
            <div class="form-group">
                ...
                @if ($data->institute_logo)
                    <img src="{{ asset('about/institute-logo/' . $data->institute_logo) }}" height="100"
                        class="mb-2" alt="Current Image">
                @endif
            </div>
