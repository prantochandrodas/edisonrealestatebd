    ...
    <div class="container mt-5">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Career-Banner</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="app-container container-fluid">
            ...
            <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
                <form action="{{ route('career-banners.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        @if ($data->image)
                            <img src="{{ asset('career-banners/'.$data->image) }}" height="100" alt="Current Image">
                        @endif
                    </div>
