...
@section('content')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Video-Gallery-Post
                    Information
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
    ...
    <div class="app-container container-fluid">
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
            <form method="POST" action="{{ route('video-gallery-posts.update', $data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    @enderror
                    @if ($data->image)
                        <img src="{{ asset('video-gallery-thumbnail-image/' . $data->image) }}" height="100" class="mb-2"
                            alt="Current Image">
                    @endif
                </div>
