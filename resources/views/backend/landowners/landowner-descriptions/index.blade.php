...
@section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container  d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1" style="padding: 0px">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Landowner-Description</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="app-container container-fluid">
        <div style="background-color: #f0f0f0; padding: 20px;">
            <h2 style="text-align: center;">Update Landowner-Description</h2>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
            <form action="{{ route('landowner-descriptions.update', $data->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    @if ($data->image)
                        <img src="{{ asset('landowner-description/' . $data->image) }}" height="100"
                            alt="Current Image">
                    @endif
                    @error('image')
                        <div class="alert alert-danger mt-2">{{ $message }}</div>
