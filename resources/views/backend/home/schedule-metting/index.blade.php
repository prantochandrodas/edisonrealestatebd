...
@section('content')
    ...
    <div class="app-container container-fluid">
        <div style="background-color: #f0f0f0; padding: 20px;">
            <h2 style="text-align: center;">Schedule-Metting</h2>
        </div>

        <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
            <form action="{{ route('schedule-mettings.update', $data->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    @if ($data->image)
                        <img src="{{ asset('home/schedulemetting/' . $data->image) }}" height="100"
                            alt="Current Image">
                    @endif
                </div>
