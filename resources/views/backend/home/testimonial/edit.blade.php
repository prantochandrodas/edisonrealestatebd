    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Testimonial
                    Post Update</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
        ...
        <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
            <form method="POST" action="{{ route('testimonials.update', $post->id) }}" enctype="multipart/form-data">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <textarea name="description" type="text" id="description" cols="30" rows="10"
                        style="width: 100%; padding: 8px;">{{ $post->description }}</textarea>
                </div>
                <div style="margin-bottom: 20px;">
