...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <a href={{ route('social-links.create') }} class="btn btn-sm btn-primary mb-2">Add</a>
    ...
    <script>
        $(document).ready(function() {
            $('#career-job').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('social-links.getdata') }}',
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return '<div style="background:black; padding:20px"><img src="application/social-link/' + data +
                                '" alt="logo" width="50" height="50"/></div>';
                        }
                    },
                    {
                        data: 'url',
