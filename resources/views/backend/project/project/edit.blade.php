        ...
        <form method="POST" action="{{ route('projects.update', $data->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control" id="status">
                    ...
                    <option value="HandedOver" {{ $data->status == 'HandedOver' ? 'selected' : '' }}>HandedOver
                    </option>
            ...
            {{-- google_map field  --}}
            <div class="form-group">
                <label for="google_map" class="mb-2 fs-5">Google Map:</label>
                ...
                <div>
                    @foreach ($data->images as $image)
                        <div class="image-container mb-3" style="position: relative; display: inline-block;">
                            <img src="{{ asset('project/' . $image->image) }}" alt="Image" width="150"
