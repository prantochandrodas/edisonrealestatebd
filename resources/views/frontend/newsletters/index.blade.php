...
@section('blog-content')
    ...
    <div class="innerBanner Loader">
        <img class="modify-img " data-image-small="{{ asset('newsletter-banners/' . $newsletterBanner->image) }}"
            ...
            data-image-standard="{{ asset('newsletter-banners/' . $newsletterBanner->image) }}" alt=""> <!--1366x400-->
        ...
        <div class="container">
            <div class="row">
                <div class="bloginit anim-parent">
                    ...
                    @foreach ($newsletterPost as $item)
                            ...
                            <div id="post-408"
                                ...
                                <div class="blog_image Loader mb30">
                                    <img class="modify-img "
                                        ...
                                        data-image-standard="{{asset('newsletter-post/'.$item->image)}}"
                                        alt="">
                                </div>
                                ...
                                <a class="dcBtn mt30" target="_blank"
                                    href="{{asset('newsletter-post-pdf/'.$item->pdf)}}"><span>Download
                                        Now</span></a>
                            </div><!-- #post-408 -->
                        </div>
                    @endforeach
