...
<!-- Mirrored from edisonrealestatebd.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jun 2024 13:23:55 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta name="keywords"
        content="Edison Real Estate, Real estate Developer in Bangladesh, real estate company in Dhaka, developer company in Bangladesh, Developer company in Dhaka, Real estate developer company, flat for sale, flat in bashundhara, residential area flat">
    <meta name="description"
        content="Edison Real Estate, the top real estate company in Dhaka,
Bangladesh, known for luxurious apartments and flats for sale, is now
expanding beyond Bashundhara R/A. We develop our projects on our own
land to offer great value for dream homes in the vibrant capital city. Explore
the finest in luxury living with Edison Real Estate.">
    ...
    <script>
        var site_url_info = {
            ...
            themeUrl: 'https://putulproperties.com/'
        }
    </script>
    <!-- Google tag (gtag.js) -->
    ...
    <script type="application/ld+json">
{
  ...
  "image": "https://edisonrealestatebd.com/themes/cms/assets/images/static/logo.svg",
  "@id": "https://edisonrealestatebd.com/themes/cms/assets/images/static/logo.svg/#logo",
  "url": "https://edisonrealestatebd.com",
  "telephone": "16760",
  "priceRange": "N/A",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Bir Uttam Mir Shawkat Road",
            ...
            $(document).ready(function() {
                ...
                function initMap() {
                    ...
                    $.each(map_json, function(i, val) {
                        var map_Array = [];
                        var custom_data = {
                            info: '<div class="map-popup">  <div class="texts"> <h4>' + val
                                .type + ' </h4><h2><a href="' + val.url + '" data-target="#' +
                                val.project_identifier + '">' + val.title + '</a></h2><p>' + val
                                .location + '</p> <a class="trigger-map" href="' + val.url +
                                '" data-target="#' + val.project_identifier + '" ><img src="' +
                                mapExplorIcon + '" alt=""></a></div> </div> ',
                            lat: Number(val.project_map_lat),
                            long: Number(val.project_map_long),
                            url: 'javascript:'
                        }
                        map_Array.push(custom_data.info, custom_data.lat, custom_data.long,
                            custom_data.url, 0);
                        ...
                        google.maps.event.addListener(marker, 'click', (function(marker, i) {
                            return function() {
                                ...
                                $('body').not(onIt).on('click', function(event) {
                                    $('.MapPopup-wrap__single').removeClass(
                                        'slideIn')
...
<!-- Mirrored from edisonrealestatebd.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jun 2024 13:24:35 GMT -->
