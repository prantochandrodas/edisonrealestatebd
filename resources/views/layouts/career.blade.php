...
<!-- Mirrored from edisonrealestatebd.com/career by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jun 2024 13:26:49 GMT -->
<!-- Added by HTTrack -->
 ...
 l21.186-23.834c1.766-2.648,2.648-6.179,1.766-8.828l-25.6-57.379C193.324,138.593,190.676,135.945,187.145,135.945" />
    ...
    <script>
        jQuery(function($) {
            ...
            $('.dynamic_upload_file_cv').fileupload({
                dataType: 'json',
                    ...
                    if (data.result.result == 'success') {
                        ...
                        $('.file_name').html(data.result.msg);
                    } else {
            ...
            jQuery('#career-form').yiiActiveForm([], []);
            $(document).ready(function() {
                $('.applyBtn').click(function() {
                    $('.careerModal').modal('hide');
                    const job_title = $(this).attr('job-position');
                    $("#apply_for_position").val(job_title);
                    $('html, body').animate({
                        scrollTop: $("#asCareerForm").offset().top
                    }, 2000);
                });
            }); //document.ready
